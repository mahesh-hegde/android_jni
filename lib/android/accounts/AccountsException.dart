...
/// from: android.accounts.AccountsException
class AccountsException extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/accounts/AccountsException");
  AccountsException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  AccountsException.ctor1(jni.JniString message)
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  AccountsException.ctor2(jni.JniString message, jni.JniObject cause)
      : super.fromRef(jniAccessors.newObjectWithArgs(
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  AccountsException.ctor3(jni.JniObject cause)
