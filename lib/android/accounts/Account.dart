...
///
/// Value type that represents an Account in the AccountManager. This object is
/// Parcelable and also overrides \#equals and \#hashCode, making it
/// suitable for use as the key of a java.util.Map
class Account extends jni.JniObject {
  static final _classRef = jniAccessors.getClassOf("android/accounts/Account");
  Account.fromRef(jni.JObject ref) : super.fromRef(ref);

  static final _id_CREATOR = jniAccessors.getStaticFieldIDOf(
      _classRef, "CREATOR", "Landroid/os/Parcelable\$Creator;");

  /// from: static public final android.os.Parcelable.Creator<android.accounts.Account> CREATOR
  ...
  /// from: public void <init>(java.lang.String name, java.lang.String type)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Account(jni.JniString name, jni.JniString type)
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  Account.ctor1(parcel_.Parcel in0)
