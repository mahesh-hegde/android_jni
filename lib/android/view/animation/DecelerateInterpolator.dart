...
/// from: android.view.animation.DecelerateInterpolator
///
/// An interpolator where the rate of change starts out quickly and
/// and then decelerates.
class DecelerateInterpolator extends baseinterpolator_.BaseInterpolator {
  static final _classRef =
      jniAccessors.getClassOf("android/view/animation/DecelerateInterpolator");
  DecelerateInterpolator.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  DecelerateInterpolator.ctor1(double factor)
