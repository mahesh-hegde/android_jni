...
/// from: android.view.animation.OvershootInterpolator
///
/// An interpolator where the change flings forward and overshoots the last value
/// then comes back.
class OvershootInterpolator extends baseinterpolator_.BaseInterpolator {
  static final _classRef =
      jniAccessors.getClassOf("android/view/animation/OvershootInterpolator");
  OvershootInterpolator.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  OvershootInterpolator.ctor1(double tension)
