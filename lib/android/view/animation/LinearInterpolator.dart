...
/// from: android.view.animation.LinearInterpolator
///
/// An interpolator where the rate of change is constant
class LinearInterpolator extends baseinterpolator_.BaseInterpolator {
  static final _classRef =
      jniAccessors.getClassOf("android/view/animation/LinearInterpolator");
  LinearInterpolator.fromRef(jni.JObject ref) : super.fromRef(ref);
