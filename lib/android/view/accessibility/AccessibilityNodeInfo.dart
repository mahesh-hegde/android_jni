...
class AccessibilityNodeInfo_RangeInfo extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(IFFF)V");

  /// from: void <init>(int type, float min, float max, float current)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Creates a new range.
  ...
  AccessibilityNodeInfo_RangeInfo(
      ...
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [type, min, max, current]).object);
...
class AccessibilityNodeInfo_CollectionItemInfo extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(IIIIZZ)V");

  /// from: void <init>(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading, boolean selected)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  AccessibilityNodeInfo_CollectionItemInfo(int rowIndex, int rowSpan,
...
class AccessibilityNodeInfo_CollectionInfo extends jni.JniObject {
  ...
  /// from: void <init>(int rowCount, int columnCount, boolean hierarchical, int selectionMode)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Creates a new instance.
  ...
  AccessibilityNodeInfo_CollectionInfo(
      int rowCount, int columnCount, bool hierarchical, int selectionMode)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
