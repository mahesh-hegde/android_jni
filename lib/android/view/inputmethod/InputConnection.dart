...
///
/// <ul>
///     <li>\#getSelectedText(int), which was introduced in
///     android.os.Build.VERSION_CODES\#GINGERBREAD.</li>
///     <li>\#setComposingRegion(int, int), which was introduced
///     in android.os.Build.VERSION_CODES\#GINGERBREAD.</li>
///     <li>\#commitCorrection(CorrectionInfo), which was introduced
///     in android.os.Build.VERSION_CODES\#HONEYCOMB.</li>
///     <li>\#requestCursorUpdates(int), which was introduced in
///     android.os.Build.VERSION_CODES\#LOLLIPOP.</li>
///     <li>\#deleteSurroundingTextInCodePoints(int, int), which
///     was introduced in android.os.Build.VERSION_CODES\#N.</li>
///     <li>\#getHandler(), which was introduced in
///     android.os.Build.VERSION_CODES\#N.</li>
///     <li>\#closeConnection(), which was introduced in
///     android.os.Build.VERSION_CODES\#N.</li>
///     <li>\#commitContent(InputContentInfo, int, Bundle), which was
...
/// android.view.inputmethod.InputMethodManager. An editor
...
///
class InputConnection extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/view/inputmethod/InputConnection");
  InputConnection.fromRef(jni.JObject ref) : super.fromRef(ref);

  /// from: static public final int CURSOR_UPDATE_IMMEDIATE
  ///
  ...
  static const CURSOR_UPDATE_IMMEDIATE = 1;

  /// from: static public final int CURSOR_UPDATE_MONITOR
  ///
  /// The editor is requested to call
  ...
  ///
  ///
  static const CURSOR_UPDATE_MONITOR = 2;

  /// from: static public final int GET_EXTRACTED_TEXT_MONITOR
  ///
  /// Flag for use with \#getExtractedText to indicate you
  /// would like to receive updates when the extracted text changes.
  static const GET_EXTRACTED_TEXT_MONITOR = 1;

  /// from: static public final int GET_TEXT_WITH_STYLES
  ///
  /// Flag for use with \#getTextAfterCursor and
  /// \#getTextBeforeCursor to have style information returned
  /// along with the text. If not set, \#getTextAfterCursor
  ...
  static const GET_TEXT_WITH_STYLES = 1;

  /// from: static public final int INPUT_CONTENT_GRANT_READ_URI_PERMISSION
  ///
  ...
  /// android.R.styleable\#AndroidManifestGrantUriPermission &lt;grant-uri-permissions&gt; tag. Otherwise InputContentInfo\#requestPermission()
  /// can fail.
  ///
  ///
  ...
  ///
  static const INPUT_CONTENT_GRANT_READ_URI_PERMISSION = 1;

  static final _id_getTextBeforeCursor = jniAccessors.getMethodIDOf(
      _classRef, "getTextBeforeCursor", "(II)Ljava/lang/CharSequence;");

  /// from: public abstract java.lang.CharSequence getTextBeforeCursor(int n, int flags)
  ...
  /// from: public abstract java.lang.CharSequence getTextAfterCursor(int n, int flags)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// from: public abstract java.lang.CharSequence getSelectedText(int flags)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// from: public abstract int getCursorCapsMode(int reqModes)
  ///
  ...
  /// EditorInfo\#inputType TextBoxAttribute.contentType value
  /// directly in to here.
  ...
  /// from: public abstract android.view.inputmethod.ExtractedText getExtractedText(android.view.inputmethod.ExtractedTextRequest request, int flags)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// if the
  /// \#GET_EXTRACTED_TEXT_MONITOR flag is set, you should be
  /// calling
  ...
  ///@return an android.view.inputmethod.ExtractedText
  ...
  /// from: public abstract boolean deleteSurroundingText(int beforeLength, int afterLength)
  ///
  ...
  ///
  ///
  /// <strong>IME authors:</strong> please be careful not to
  ...
  /// the editor to call
  /// android.inputmethodservice.InputMethodService\#onUpdateSelection(int, int, int, int,
  /// int, int) on your service after the batch input is over.
  ///
  ///
  /// <strong>Editor authors:</strong> please be careful of race
  /// conditions in implementing this call. An IME can make a change
  ...
  /// from: public abstract boolean deleteSurroundingTextInCodePoints(int beforeLength, int afterLength)
  ///
  ...
  /// </ul>
  ///
  /// <strong>Editor authors:</strong> In addition to the requirement in
  /// \#deleteSurroundingText(int, int), make sure to do nothing when one ore more invalid
  ...
  /// from: public abstract boolean setComposingText(java.lang.CharSequence text, int newCursorPosition)
  ///
  ...
  /// from: public abstract boolean setComposingRegion(int start, int end)
  ///
  ...
  /// from: public abstract boolean finishComposingText()
  ///
  ...
  /// from: public abstract boolean commitText(java.lang.CharSequence text, int newCursorPosition)
  ///
  ...
  /// \#setComposingText(CharSequence, int) setComposingText(text, newCursorPosition)
  ...
  /// from: public abstract boolean commitCompletion(android.view.inputmethod.CompletionInfo text)
  ///
  /// Commit a completion the user has selected from the possible ones
  /// previously reported to InputMethodSession\#displayCompletions InputMethodSession\#displayCompletions(CompletionInfo[]) or
  /// InputMethodManager\#displayCompletions InputMethodManager\#displayCompletions(View, CompletionInfo[]).
  ...
  /// from: public abstract boolean commitCorrection(android.view.inputmethod.CorrectionInfo correctionInfo)
  ///
  ...
  /// from: public abstract boolean setSelection(int start, int end)
  ///
  ...
  /// from: public abstract boolean performEditorAction(int editorAction)
  ///
  ...
  /// EditorInfo\#imeOptions EditorInfo.editorType, such as
  /// EditorInfo\#IME_ACTION_GO EditorInfo.EDITOR_ACTION_GO.
  ///@return true on success, false if the input connection is no longer
  /// valid.
  ...
  /// from: public abstract boolean performContextMenuAction(int id)
  ///
  ...
  /// from: public abstract boolean beginBatchEdit()
  ///
  ...
  /// from: public abstract boolean endBatchEdit()
  ///
  /// Tell the editor that you are done with a batch edit previously
  /// initiated with \#beginBatchEdit. This ends the latest
  /// batch only.
  ///
  /// <strong>IME authors:</strong> make sure you call this
  /// exactly once for each call to \#beginBatchEdit.
  ///
  ///
  /// <strong>Editor authors:</strong> please be careful about
  ...
  /// from: public abstract boolean sendKeyEvent(android.view.KeyEvent event)
  ///
  ...
  /// KeyEvent\#FLAG_SOFT_KEYBOARD KeyEvent.FLAG_SOFT_KEYBOARD
  ...
  /// the \#commitText family of methods to send text to the
  /// application instead.
  ///
  ...
  /// from: public abstract boolean clearMetaKeyStates(int states)
  ///
  ...
  /// per KeyEvent\#getMetaState() KeyEvent.getMetaState().
  ///@return true on success, false if the input connection is no longer
  /// valid.
  ...
  /// from: public abstract boolean reportFullscreenMode(boolean enabled)
  ///
  /// Called back when the connected IME switches between fullscreen and normal modes.
  ///
  /// Note: On android.os.Build.VERSION_CODES\#O and later devices, input methods are no
  ...
  /// InputMethodService\#updateFullscreenMode() instead. This approach should work on API
  /// android.os.Build.VERSION_CODES\#N_MR1 and prior devices.
  ///
  ...
  /// from: public abstract boolean performPrivateCommand(java.lang.String action, android.os.Bundle data)
  ///
  ...
  /// information in EditorInfo to determine if a client
  ...
  /// from: public abstract boolean requestCursorUpdates(int cursorUpdateMode)
  ///
  ...
  /// \#CURSOR_UPDATE_MONITOR. Pass {@code 0} to disable the effect of
  ...
  /// from: public abstract android.os.Handler getHandler()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Called by the InputMethodManager to enable application developers to specify a
  ...
  ///
  ///@return {@code null} to use the default Handler.
  ...
  /// from: public abstract void closeConnection()
  ///
  ...
  ///
  /// <strong>Editor authors</strong>: You can clear all the nested batch edit right now and
  ...
  /// from: public abstract boolean commitContent(android.view.inputmethod.InputContentInfo inputContentInfo, int flags, android.os.Bundle opts)
  ///
  ...
  ///
  /// <ul>
  ///     <li>Editor must keep EditorInfo\#contentMimeTypes equal to {@code null} if it does
  ///     not support this method at all.</li>
  ///     <li>Editor can ignore this request when the MIME type specified in
  ///     {@code inputContentInfo} does not match any of EditorInfo\#contentMimeTypes.
  ///     </li>
  ...
  ///     EditorInfo\#packageName about how to obtain the package name of the editor.</li>
  /// </ul>
  ///@param inputContentInfo Content to be inserted.
  /// This value must never be {@code null}.
  ///@param flags \#INPUT_CONTENT_GRANT_READ_URI_PERMISSION if the content provider
  /// allows android.R.styleable\#AndroidManifestProvider_grantUriPermissions grantUriPermissions or {@code 0} if the application does not need to call
