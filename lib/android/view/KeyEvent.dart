...
class KeyEvent extends inputevent_.InputEvent {
  ...
  KeyEvent(int action, int code)
      : super.fromRef(jniAccessors
            .newObjectWithArgs(_classRef, _id_ctor, [action, code]).object);
  ...
  KeyEvent.ctor1(int downTime, int eventTime, int action, int code, int repeat)
  ...
  ///@param deviceId The device ID that generated the key event.
  ///@param flags The flags for this key event
  KeyEvent.ctor6(int time, jni.JniString characters, int deviceId, int flags)
  ...
  KeyEvent.ctor7(KeyEvent origEvent)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor7, [origEvent.reference]).object);
  ...
  KeyEvent.ctor8(KeyEvent origEvent, int eventTime, int newRepeat)
