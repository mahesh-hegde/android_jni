...
class Choreographer extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/os/Looper;I)V");

  /// from: void <init>(android.os.Looper looper, int vsyncSource)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Choreographer(looper_.Looper looper, int vsyncSource)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [looper.reference, vsyncSource]).object);
