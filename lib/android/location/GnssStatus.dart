...
class GnssStatus extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(I[I[F[F[F[F)V");

  /// from: void <init>(int svCount, int[] svidWithFlags, float[] cn0s, float[] elevations, float[] azimuths, float[] carrierFrequencies)
  /// The returned object must be deleted after use, by calling the `delete` method.
  GnssStatus(
      int svCount,
      jni.JniObject svidWithFlags,
      jni.JniObject cn0s,
      jni.JniObject elevations,
      jni.JniObject azimuths,
      jni.JniObject carrierFrequencies)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [
          svCount,
          svidWithFlags.reference,
          cn0s.reference,
          elevations.reference,
          azimuths.reference,
          carrierFrequencies.reference
        ]).object);
