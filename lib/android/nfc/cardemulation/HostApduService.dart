...
/// </pre>
///
/// The android.R.styleable\#HostApduService &lt;host-apdu-service&gt; is required
/// to contain a
...
/// The
/// android.R.styleable\#HostApduService_requireDeviceUnlock &lt;requireDeviceUnlock&gt;
/// attribute can be used to specify that the device must be unlocked before this service
/// can be invoked to handle APDUs.
/// The android.R.styleable\#HostApduService &lt;host-apdu-service&gt; must
...
/// on the device.
class HostApduService extends service_.Service {
  static final _classRef =
      jniAccessors.getClassOf("android/nfc/cardemulation/HostApduService");
  HostApduService.fromRef(jni.JObject ref) : super.fromRef(ref);

  /// from: static public final int DEACTIVATION_DESELECTED
  ///
  /// Reason for \#onDeactivated(int).
  ///
  /// Indicates deactivation was due to a different AID
  ...
  static const DEACTIVATION_DESELECTED = 1;
  ...
  static final _id_sendResponseApdu =
      jniAccessors.getMethodIDOf(_classRef, "sendResponseApdu", "([B)V");

  /// from: public final void sendResponseApdu(byte[] responseApdu)
  ///
  ...
  void sendResponseApdu(jni.JniObject responseApdu) =>
      jniAccessors.callMethodWithArgs(reference, _id_sendResponseApdu,
          jni.JniType.voidType, [responseApdu.reference]).check();

  static final _id_notifyUnhandled =
      jniAccessors.getMethodIDOf(_classRef, "notifyUnhandled", "()V");

  /// from: public final void notifyUnhandled()
  ///
  ...
  ///    call and a \#onDeactivated(int) call.
  void notifyUnhandled() => jniAccessors.callMethodWithArgs(
      reference, _id_notifyUnhandled, jni.JniType.voidType, []).check();

  static final _id_processCommandApdu = jniAccessors.getMethodIDOf(
      _classRef, "processCommandApdu", "([BLandroid/os/Bundle;)[B");

  /// from: public abstract byte[] processCommandApdu(byte[] commandApdu, android.os.Bundle extras)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// and use the \#sendResponseApdu(byte[]) method later.
  ...
  jni.JniObject processCommandApdu(
          jni.JniObject commandApdu, bundle_.Bundle extras) =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          reference,
          _id_processCommandApdu,
          jni.JniType.objectType,
          [commandApdu.reference, extras.reference]).object);
