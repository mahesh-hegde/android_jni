...
class ImageFormat extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/graphics/ImageFormat");
  ImageFormat.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// android.hardware.camera2.CameraCharacteristics\#REQUEST_AVAILABLE_CAPABILITIES_DEPTH_OUTPUT DEPTH_OUTPUT
  ...
  /// android.media.Image\#getPlanes() Image\#getPlanes() is guaranteed such that
  ...
  /// through android.media.MediaCodec\#getOutputImage object.
  ///
  ...
  /// android.media.ImageWriter ImageWriter , and interpreted correctly
  /// by consumers like android.hardware.camera2.CameraDevice CameraDevice based on the device/framework private information. However,
  /// these buffers are not directly accessible to the application.
  ///
  ///
  ///
  /// When an android.media.Image Image of this format is obtained from
  /// an android.media.ImageReader ImageReader or
  /// android.media.ImageWriter ImageWriter, the
  /// android.media.Image\#getPlanes() getPlanes() method will return an
  /// empty android.media.Image.Plane Plane array.
  ///
  ///
  ///
  ...
  ///
  ///
  /// <pre>size = row stride * height</pre> where the row stride is in _bytes_,
  /// not pixels.
  ///
  ///
  ...
  /// android.media.Image\#getPlanes() Image\#getPlanes() will return a
  ...
  /// android.media.Image.Plane\#getPixelStride() yPlane.getPixelStride()).
  ///
  ///
  /// The U/V planes are guaranteed to have the same row stride and pixel stride
  /// (in particular,
  /// android.media.Image.Plane\#getRowStride() uPlane.getRowStride()
  /// == android.media.Image.Plane\#getRowStride() vPlane.getRowStride() and
  ...
  /// through a android.media.ImageReader object.
  ///
  ///@see android.media.Image
  ///@see android.media.ImageReader
  ///@see android.hardware.camera2.CameraDevice
  ...
  ///
  ///
  /// This is an alternative format for android.hardware.Camera preview images. Whether
  ...
  static final _id_getBitsPerPixel =
      jniAccessors.getStaticMethodIDOf(_classRef, "getBitsPerPixel", "(I)I");

  /// from: static public int getBitsPerPixel(int format)
  ///
  ...
  static int getBitsPerPixel(int format) =>
      jniAccessors.callStaticMethodWithArgs(_classRef, _id_getBitsPerPixel,
          jni.JniType.intType, [format]).integer;
}
