...
/// from: android.graphics.MaskFilter
///
...
class MaskFilter extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/graphics/MaskFilter");
  MaskFilter.fromRef(jni.JObject ref) : super.fromRef(ref);
