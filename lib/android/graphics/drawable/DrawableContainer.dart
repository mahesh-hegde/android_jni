...
class DrawableContainer_DrawableContainerState
  ...
  static final _id_ctor1 = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/graphics/drawable/DrawableContainer\$DrawableContainerState;Landroid/graphics/drawable/DrawableContainer;Landroid/content/res/Resources;)V");

  /// from: void <init>(android.graphics.drawable.DrawableContainer.DrawableContainerState orig, android.graphics.drawable.DrawableContainer owner, android.content.res.Resources res)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  DrawableContainer_DrawableContainerState.ctor1(
      DrawableContainer_DrawableContainerState orig,
      DrawableContainer owner,
      resources_.Resources res)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor1,
            [orig.reference, owner.reference, res.reference]).object);
