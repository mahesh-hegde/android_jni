...
class ColorSpace_Rgb extends ColorSpace {
  ...
  /// </ul>
  ///@see \#get(Named)
  ColorSpace_Rgb(jni.JniString name, jni.JniObject toXYZ, jni.JniObject oetf,
      jni.JniObject eotf)
  ...
  /// </ul>
  ///@see \#get(Named)
  ColorSpace_Rgb.ctor2(jni.JniString name, jni.JniObject toXYZ,
  ...
  /// </ul>
  ///@see \#get(Named)
  ColorSpace_Rgb.ctor3(jni.JniString name, jni.JniObject primaries,
  ...
  /// </ul>
  ///@see \#get(Named)
  ColorSpace_Rgb.ctor4(jni.JniString name, jni.JniObject toXYZ, double gamma)
  ...
  /// </ul>
  ///@see \#get(Named)
  ColorSpace_Rgb.ctor5(jni.JniString name, jni.JniObject primaries,
