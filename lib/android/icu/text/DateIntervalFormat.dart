...
import "DateIntervalInfo.dart" as dateintervalinfo_;

import "../util/DateInterval.dart" as dateinterval_;
...
/// from: android.icu.text.DateIntervalFormat
///
...
class DateIntervalFormat extends uformat_.UFormat {
  static final _classRef =
      jniAccessors.getClassOf("android/icu/text/DateIntervalFormat");
  DateIntervalFormat.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// from: static public final android.icu.text.DateIntervalFormat getInstance(java.lang.String skeleton)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  ///@see Category\#FORMAT
  static DateIntervalFormat getInstance(jni.JniString skeleton) =>
      DateIntervalFormat.fromRef(jniAccessors.callStaticMethodWithArgs(
          _classRef,
          _id_getInstance,
  ...
  /// from: static public final android.icu.text.DateIntervalFormat getInstance(java.lang.String skeleton, java.util.Locale locale)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// getInstance(String skeleton, ULocale locale)
  ///
  /// Example code:{@sample external/icu/android_icu4j/src/samples/java/android/icu/samples/text/dateintervalformat/DateIntervalFormatSample.java dtitvfmtPreDefinedExample}
  ///@param skeleton the skeleton on which interval format based.
  ///@param locale the given locale
  ///@return a date time interval formatter.
  static DateIntervalFormat getInstance1(
  ...
  /// from: static public final android.icu.text.DateIntervalFormat getInstance(java.lang.String skeleton, android.icu.util.ULocale locale)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Construct a DateIntervalFormat from skeleton and a given locale.
  /// <P>
  ...
  ///@param locale the given locale
  ///@return a date time interval formatter.
  static DateIntervalFormat getInstance2(
  ...
  /// from: static public final android.icu.text.DateIntervalFormat getInstance(java.lang.String skeleton, android.icu.text.DateIntervalInfo dtitvinf)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  ///@return a date time interval formatter.
  ///@see Category\#FORMAT
  static DateIntervalFormat getInstance3(jni.JniString skeleton,
          dateintervalinfo_.DateIntervalInfo dtitvinf) =>
      DateIntervalFormat.fromRef(jniAccessors.callStaticMethodWithArgs(
          _classRef,
          _id_getInstance3,
          jni.JniType.objectType,
          [skeleton.reference, dtitvinf.reference]).object);
  ...
  /// from: static public final android.icu.text.DateIntervalFormat getInstance(java.lang.String skeleton, java.util.Locale locale, android.icu.text.DateIntervalInfo dtitvinf)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Construct a DateIntervalFormat from skeleton
  ...
  /// getInstance(String skeleton, ULocale locale, DateIntervalInfo dtitvinf)
  ///
  /// Example code:{@sample external/icu/android_icu4j/src/samples/java/android/icu/samples/text/dateintervalformat/DateIntervalFormatSample.java dtitvfmtCustomizedExample}
  ///@param skeleton the skeleton on which interval format based.
  ///@param locale the given locale
  ///@param dtitvinf the DateIntervalInfo object to be adopted.
  ///@return a date time interval formatter.
  static DateIntervalFormat getInstance4(jni.JniString skeleton,
          jni.JniObject locale, dateintervalinfo_.DateIntervalInfo dtitvinf) =>
      DateIntervalFormat.fromRef(jniAccessors.callStaticMethodWithArgs(
          _classRef,
          _id_getInstance4,
          jni.JniType.objectType,
          [skeleton.reference, locale.reference, dtitvinf.reference]).object);
  ...
  /// from: static public final android.icu.text.DateIntervalFormat getInstance(java.lang.String skeleton, android.icu.util.ULocale locale, android.icu.text.DateIntervalInfo dtitvinf)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Construct a DateIntervalFormat from skeleton
  /// a DateIntervalInfo, and the given locale.
  ...
  ///@param dtitvinf the DateIntervalInfo object to be adopted.
  ///@return a date time interval formatter.
  static DateIntervalFormat getInstance5(
          jni.JniString skeleton,
  ...
  /// from: synchronized public java.lang.Object clone()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// from: public final java.lang.StringBuffer format(java.lang.Object obj, java.lang.StringBuffer appendTo, java.text.FieldPosition fieldPosition)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  ///                                      DateInterval object
  jni.JniObject format(jni.JniObject obj, jni.JniObject appendTo,
          jni.JniObject fieldPosition) =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          reference,
          _id_format,
          jni.JniType.objectType,
          [obj.reference, appendTo.reference, fieldPosition.reference]).object);
  ...
  /// from: synchronized public final java.lang.StringBuffer format(android.icu.util.DateInterval dtInterval, java.lang.StringBuffer appendTo, java.text.FieldPosition fieldPosition)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  ///                          offsets refer to the first instance.
  ///@return Reference to 'appendTo' parameter.
  jni.JniObject format1(dateinterval_.DateInterval dtInterval,
          jni.JniObject appendTo, jni.JniObject fieldPosition) =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_format1, jni.JniType.objectType, [
        dtInterval.reference,
        appendTo.reference,
  ...
  /// from: synchronized public final java.lang.StringBuffer format(android.icu.util.Calendar fromCalendar, android.icu.util.Calendar toCalendar, java.lang.StringBuffer appendTo, java.text.FieldPosition pos)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  jni.JniObject format2(
          calendar_.Calendar fromCalendar,
          calendar_.Calendar toCalendar,
          jni.JniObject appendTo,
          jni.JniObject pos) =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_format2, jni.JniType.objectType, [
        fromCalendar.reference,
        toCalendar.reference,
        appendTo.reference,
        pos.reference
      ]).object);
  ...
  /// from: public java.lang.Object parseObject(java.lang.String source, java.text.ParsePosition parse_pos)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  jni.JniObject parseObject(jni.JniString source, jni.JniObject parse_pos) =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          reference,
          _id_parseObject,
          jni.JniType.objectType,
          [source.reference, parse_pos.reference]).object);

  static final _id_getDateIntervalInfo = jniAccessors.getMethodIDOf(_classRef,
      "getDateIntervalInfo", "()Landroid/icu/text/DateIntervalInfo;");

  /// from: public android.icu.text.DateIntervalInfo getDateIntervalInfo()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Gets the date time interval patterns.
  ///@return a copy of the date time interval patterns associated with
  /// this date interval formatter.
  dateintervalinfo_.DateIntervalInfo getDateIntervalInfo() =>
      dateintervalinfo_.DateIntervalInfo.fromRef(jniAccessors
          .callMethodWithArgs(reference, _id_getDateIntervalInfo,
              jni.JniType.objectType, []).object);

  static final _id_setDateIntervalInfo = jniAccessors.getMethodIDOf(_classRef,
      "setDateIntervalInfo", "(Landroid/icu/text/DateIntervalInfo;)V");

  /// from: public void setDateIntervalInfo(android.icu.text.DateIntervalInfo newItvPattern)
  ///
  /// Set the date time interval patterns.
  ///@param newItvPattern the given interval patterns to copy.
  void setDateIntervalInfo(dateintervalinfo_.DateIntervalInfo newItvPattern) =>
      jniAccessors.callMethodWithArgs(reference, _id_setDateIntervalInfo,
          jni.JniType.voidType, [newItvPattern.reference]).check();
  ...
  static final _id_getDateFormat = jniAccessors.getMethodIDOf(
      _classRef, "getDateFormat", "()Landroid/icu/text/DateFormat;");

  /// from: synchronized public android.icu.text.DateFormat getDateFormat()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Gets the date formatter
  ///@return a copy of the date formatter associated with
  /// this date interval formatter.
  dateformat_.DateFormat getDateFormat() =>
      dateformat_.DateFormat.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_getDateFormat, jni.JniType.objectType, []).object);
}
