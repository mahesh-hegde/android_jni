...
class AlphabeticIndex_Bucket extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Ljava/lang/String;Ljava/lang/String;Landroid/icu/text/AlphabeticIndex\$Bucket\$LabelType;)V");

  /// from: void <init>(java.lang.String label, java.lang.String lowerBoundary, android.icu.text.AlphabeticIndex.Bucket.LabelType labelType)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Set up the bucket.
  ///@param label label for the bucket
  ///@param labelType is an underflow, overflow, or inflow bucket
  AlphabeticIndex_Bucket(jni.JniString label, jni.JniString lowerBoundary,
      AlphabeticIndex_Bucket_LabelType labelType)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [
          label.reference,
          lowerBoundary.reference,
          labelType.reference
        ]).object);
