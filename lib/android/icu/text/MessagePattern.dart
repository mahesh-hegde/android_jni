...
class MessagePattern_Part extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/icu/text/MessagePattern\$Part\$Type;III)V");

  /// from: void <init>(android.icu.text.MessagePattern.Part.Type t, int i, int l, int v)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MessagePattern_Part(MessagePattern_Part_Type t, int i, int l, int v)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [t.reference, i, l, v]).object);
