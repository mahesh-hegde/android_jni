...
import "DateFormat.dart" as dateformat_;

import "../util/ULocale.dart" as ulocale_;

import "DateFormatSymbols.dart" as dateformatsymbols_;
...
import "TimeZoneFormat.dart" as timezoneformat_;
import "../../../_init.dart" show jniEnv, jniAccessors;

/// from: android.icu.text.SimpleDateFormat
///
...
///
///
/// Date and time formats are specified by _date and time pattern_ strings.
...
///         <td style="text-align: center">1..2</td>
///         <td>02</td>
///         <td rowspan="3">__Stand-Alone__ Quarter - Use one or two for the numerical quarter, three for the abbreviation,
...
///         <td style="text-align: center">1..2</td>
///         <td>09</td>
///         <td rowspan="4">__Stand-Alone__ Month - Use one or two for the numerical month, three for the abbreviation,
...
///         <td style="text-align: center">1</td>
///         <td>2</td>
///         <td rowspan="5">__Stand-Alone__ local day of week - Use one letter for the local numeric value (same
...
///         <i>__Note__: This specifier was originally used for a variant of the short specific non-location format,
...
/// android.icu.lang.UCharacter\#isDigit(int), will be parsed into the default
/// century.
...
class SimpleDateFormat extends dateformat_.DateFormat {
  static final _classRef =
      jniAccessors.getClassOf("android/icu/text/SimpleDateFormat");
  SimpleDateFormat.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// locale.  __Note:__ Not all locales support SimpleDateFormat; for full
  ...
  /// generality, use the factory methods in the DateFormat class.
  ///@see Category\#FORMAT
  SimpleDateFormat.ctor1(jni.JniString pattern)
  ...
  /// from: public void <init>(java.lang.String pattern, java.util.Locale loc)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Constructs a SimpleDateFormat using the given pattern and locale.
  /// __Note:__ Not all locales support SimpleDateFormat; for full
  /// generality, use the factory methods in the DateFormat class.
  SimpleDateFormat.ctor2(jni.JniString pattern, jni.JniObject loc)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor2, [pattern.reference, loc.reference]).object);

  static final _id_ctor3 = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Ljava/lang/String;Landroid/icu/util/ULocale;)V");

  /// from: public void <init>(java.lang.String pattern, android.icu.util.ULocale loc)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Constructs a SimpleDateFormat using the given pattern and locale.
  /// __Note:__ Not all locales support SimpleDateFormat; for full
  /// generality, use the factory methods in the DateFormat class.
  SimpleDateFormat.ctor3(jni.JniString pattern, ulocale_.ULocale loc)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor3, [pattern.reference, loc.reference]).object);
  ...
  /// from: public void <init>(java.lang.String pattern, java.lang.String override, android.icu.util.ULocale loc)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  SimpleDateFormat.ctor4(
      jni.JniString pattern, jni.JniString override, ulocale_.ULocale loc)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor4,
            [pattern.reference, override.reference, loc.reference]).object);

  static final _id_ctor5 = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Ljava/lang/String;Landroid/icu/text/DateFormatSymbols;)V");

  /// from: public void <init>(java.lang.String pattern, android.icu.text.DateFormatSymbols formatData)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Constructs a SimpleDateFormat using the given pattern and
  /// locale-specific symbol data.
  /// Warning: uses default <code>FORMAT</code> locale for digits!
  SimpleDateFormat.ctor5(
      jni.JniString pattern, dateformatsymbols_.DateFormatSymbols formatData)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor5,
            [pattern.reference, formatData.reference]).object);

  static final _id_set2DigitYearStart = jniAccessors.getMethodIDOf(
      _classRef, "set2DigitYearStart", "(Ljava/util/Date;)V");

  /// from: public void set2DigitYearStart(java.util.Date startDate)
  ///
  /// Sets the 100-year period 2-digit years will be interpreted as being in
  /// to begin on the date the user specifies.
  ///@param startDate During parsing, two digit years will be placed in the range
  /// <code>startDate</code> to <code>startDate + 100 years</code>.
  void set2DigitYearStart(jni.JniObject startDate) =>
      jniAccessors.callMethodWithArgs(reference, _id_set2DigitYearStart,
          jni.JniType.voidType, [startDate.reference]).check();

  static final _id_get2DigitYearStart = jniAccessors.getMethodIDOf(
      _classRef, "get2DigitYearStart", "()Ljava/util/Date;");
  ...
  /// parsed
  jni.JniObject get2DigitYearStart() =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(reference,
          _id_get2DigitYearStart, jni.JniType.objectType, []).object);
  ...
  /// from: public java.lang.StringBuffer format(android.icu.util.Calendar cal, java.lang.StringBuffer toAppendTo, java.text.FieldPosition pos)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  jni.JniObject format1(calendar_.Calendar cal, jni.JniObject toAppendTo,
      ...
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          ...
          [cal.reference, toAppendTo.reference, pos.reference]).object);

  static final _id_patternCharToDateFormatField = jniAccessors.getMethodIDOf(
      _classRef,
      "patternCharToDateFormatField",
      "(C)Landroid/icu/text/DateFormat\$Field;");

  /// from: protected android.icu.text.DateFormat.Field patternCharToDateFormatField(char ch)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  dateformat_.DateFormat_Field patternCharToDateFormatField(int ch) =>
      dateformat_.DateFormat_Field.fromRef(jniAccessors.callMethodWithArgs(
          reference,
          _id_patternCharToDateFormatField,
          jni.JniType.objectType,
          [ch]).object);

  static final _id_subFormat = jniAccessors.getMethodIDOf(
      _classRef,
      "subFormat",
      "(CIILjava/text/FieldPosition;Landroid/icu/text/DateFormatSymbols;Landroid/icu/util/Calendar;)Ljava/lang/String;");

  /// from: protected java.lang.String subFormat(char ch, int count, int beginOffset, java.text.FieldPosition pos, android.icu.text.DateFormatSymbols fmtData, android.icu.util.Calendar cal)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  jni.JniString subFormat(
          int ch,
          int count,
          int beginOffset,
          jni.JniObject pos,
          dateformatsymbols_.DateFormatSymbols fmtData,
          calendar_.Calendar cal) =>
      jni.JniString.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_subFormat, jni.JniType.objectType, [
        ch,
        count,
        beginOffset,
        pos.reference,
  ...
  static final _id_zeroPaddingNumber = jniAccessors.getMethodIDOf(
      _classRef, "zeroPaddingNumber", "(JII)Ljava/lang/String;");

  /// from: protected java.lang.String zeroPaddingNumber(long value, int minDigits, int maxDigits)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Formats a number with the specified minimum and maximum number of digits.
  jni.JniString zeroPaddingNumber(int value, int minDigits, int maxDigits) =>
      jni.JniString.fromRef(jniAccessors.callMethodWithArgs(
          reference,
          _id_zeroPaddingNumber,
          jni.JniType.objectType,
          [value, minDigits, maxDigits]).object);
  ...
  /// from: public void parse(java.lang.String text, android.icu.util.Calendar cal, java.text.ParsePosition parsePos)
  ///
  /// Overrides DateFormat
  ///@see DateFormat
  void parse1(
          jni.JniString text, calendar_.Calendar cal, jni.JniObject parsePos) =>
      jniAccessors.callMethodWithArgs(
          reference,
          _id_parse1,
          jni.JniType.voidType,
          [text.reference, cal.reference, parsePos.reference]).check();

  static final _id_matchString = jniAccessors.getMethodIDOf(
      _classRef,
      "matchString",
      "(Ljava/lang/String;II[Ljava/lang/String;Landroid/icu/util/Calendar;)I");

  /// from: protected int matchString(java.lang.String text, int start, int field, java.lang.String[] data, android.icu.util.Calendar cal)
  ///
  ...
  int matchString(jni.JniString text, int start, int field, jni.JniObject data,
          calendar_.Calendar cal) =>
      jniAccessors.callMethodWithArgs(
          reference, _id_matchString, jni.JniType.intType, [
        text.reference,
        start,
        field,
        data.reference,
  ...
  static final _id_matchQuarterString = jniAccessors.getMethodIDOf(
      _classRef,
      "matchQuarterString",
      "(Ljava/lang/String;II[Ljava/lang/String;Landroid/icu/util/Calendar;)I");

  /// from: protected int matchQuarterString(java.lang.String text, int start, int field, java.lang.String[] data, android.icu.util.Calendar cal)
  ///
  ...
  /// sets the <code>cal</code> field <code>field</code> to the index
  /// of the best match, if matching succeeded.
  int matchQuarterString(jni.JniString text, int start, int field,
          jni.JniObject data, calendar_.Calendar cal) =>
      jniAccessors.callMethodWithArgs(
          reference, _id_matchQuarterString, jni.JniType.intType, [
        text.reference,
        start,
        field,
        data.reference,
  ...
  static final _id_subParse = jniAccessors.getMethodIDOf(_classRef, "subParse",
      "(Ljava/lang/String;ICIZZ[ZLandroid/icu/util/Calendar;)I");

  /// from: protected int subParse(java.lang.String text, int start, char ch, int count, boolean obeyCount, boolean allowNegative, boolean[] ambiguousYear, android.icu.util.Calendar cal)
  ///
  ...
  int subParse(
          ...
          bool obeyCount,
          bool allowNegative,
          jni.JniObject ambiguousYear,
          calendar_.Calendar cal) =>
      jniAccessors
          .callMethodWithArgs(reference, _id_subParse, jni.JniType.intType, [
        text.reference,
        start,
        ch,
        count,
  ...
  ///
  /// __Note:__ This implementation depends on DateFormatSymbols\#getLocalPatternChars()
  ...
  /// from: public void applyPattern(java.lang.String pat)
  ///
  /// Apply the given unlocalized pattern string to this date format.
  void applyPattern(jni.JniString pat) => jniAccessors.callMethodWithArgs(
      reference,
      _id_applyPattern,
      jni.JniType.voidType,
      [pat.reference]).check();
  ...
  /// from: public void applyLocalizedPattern(java.lang.String pat)
  ///
  /// Apply the given localized pattern string to this date format.
  void applyLocalizedPattern(jni.JniString pat) =>
      jniAccessors.callMethodWithArgs(reference, _id_applyLocalizedPattern,
          jni.JniType.voidType, [pat.reference]).check();

  static final _id_getDateFormatSymbols = jniAccessors.getMethodIDOf(_classRef,
      "getDateFormatSymbols", "()Landroid/icu/text/DateFormatSymbols;");

  /// from: public android.icu.text.DateFormatSymbols getDateFormatSymbols()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Gets the date/time formatting data.
  ///@return a copy of the date-time formatting data associated
  /// with this date-time formatter.
  dateformatsymbols_.DateFormatSymbols getDateFormatSymbols() =>
      dateformatsymbols_.DateFormatSymbols.fromRef(jniAccessors
          .callMethodWithArgs(reference, _id_getDateFormatSymbols,
              jni.JniType.objectType, []).object);

  static final _id_setDateFormatSymbols = jniAccessors.getMethodIDOf(_classRef,
      "setDateFormatSymbols", "(Landroid/icu/text/DateFormatSymbols;)V");

  /// from: public void setDateFormatSymbols(android.icu.text.DateFormatSymbols newFormatSymbols)
  ///
  /// Allows you to set the date/time formatting data.
  ///@param newFormatSymbols the new symbols
  void setDateFormatSymbols(
          dateformatsymbols_.DateFormatSymbols newFormatSymbols) =>
      jniAccessors.callMethodWithArgs(reference, _id_setDateFormatSymbols,
          jni.JniType.voidType, [newFormatSymbols.reference]).check();

  static final _id_getSymbols = jniAccessors.getMethodIDOf(
      _classRef, "getSymbols", "()Landroid/icu/text/DateFormatSymbols;");

  /// from: protected android.icu.text.DateFormatSymbols getSymbols()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Method for subclasses to access the DateFormatSymbols.
  dateformatsymbols_.DateFormatSymbols getSymbols() =>
      dateformatsymbols_.DateFormatSymbols.fromRef(jniAccessors
          .callMethodWithArgs(
              reference, _id_getSymbols, jni.JniType.objectType, []).object);

  static final _id_getTimeZoneFormat = jniAccessors.getMethodIDOf(
      _classRef, "getTimeZoneFormat", "()Landroid/icu/text/TimeZoneFormat;");

  /// from: public android.icu.text.TimeZoneFormat getTimeZoneFormat()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  /// formatter uses.
  timezoneformat_.TimeZoneFormat getTimeZoneFormat() =>
      timezoneformat_.TimeZoneFormat.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_getTimeZoneFormat, jni.JniType.objectType, []).object);

  static final _id_setTimeZoneFormat = jniAccessors.getMethodIDOf(
      _classRef, "setTimeZoneFormat", "(Landroid/icu/text/TimeZoneFormat;)V");

  /// from: public void setTimeZoneFormat(android.icu.text.TimeZoneFormat tzfmt)
  ///
  /// <strong>[icu]</strong> Allows you to set the time zone formatter.
  ///@param tzfmt the new time zone formatter
  void setTimeZoneFormat(timezoneformat_.TimeZoneFormat tzfmt) =>
      jniAccessors.callMethodWithArgs(reference, _id_setTimeZoneFormat,
          jni.JniType.voidType, [tzfmt.reference]).check();
  ...
  static final _id_setNumberFormat1 = jniAccessors.getMethodIDOf(
      _classRef,
      "setNumberFormat",
      "(Ljava/lang/String;Landroid/icu/text/NumberFormat;)V");

  /// from: public void setNumberFormat(java.lang.String fields, android.icu.text.NumberFormat overrideNF)
  ///
  ...
  void setNumberFormat1(
          jni.JniString fields, numberformat_.NumberFormat overrideNF) =>
      jniAccessors.callMethodWithArgs(
          reference,
          _id_setNumberFormat1,
          jni.JniType.voidType,
          [fields.reference, overrideNF.reference]).check();

  static final _id_getNumberFormat1 = jniAccessors.getMethodIDOf(
      _classRef, "getNumberFormat", "(C)Landroid/icu/text/NumberFormat;");

  /// from: public android.icu.text.NumberFormat getNumberFormat(char field)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  numberformat_.NumberFormat getNumberFormat1(int field) =>
      numberformat_.NumberFormat.fromRef(jniAccessors.callMethodWithArgs(
          reference,
          _id_getNumberFormat1,
          jni.JniType.objectType,
          [field]).object);
}
