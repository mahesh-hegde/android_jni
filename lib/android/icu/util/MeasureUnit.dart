...
class MeasureUnit extends jni.JniObject {
  ...
  /// from: void <init>(java.lang.String type, java.lang.String subType)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @deprecated This API is ICU internal only.
  ///@hide original deprecated declaration
  ///@hide draft / provisional / internal are hidden on Android
  MeasureUnit(jni.JniString type, jni.JniString subType)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [type.reference, subType.reference]).object);
