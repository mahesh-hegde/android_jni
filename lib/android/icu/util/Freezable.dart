...
/// from: android.icu.util.Freezable
///
...
/// with the above steps. But remember that you <i>__have__</i> allowed
...
///
///
/// These also illustrated in the code sample in __Background__ above.
///
///
///
...
///
///
/// __Warning!__ The 'frozen' boolean MUST be volatile, and must be set as the last statement
/// in the method.
///
/// <pre>
/// public A freeze() {
...
/// <blockquote>
///
/// __Note: __An annoying flaw in Java is that the generic collections, like
...
///
/// </blockquote>
class Freezable extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/icu/util/Freezable");
  Freezable.fromRef(jni.JObject ref) : super.fromRef(ref);
