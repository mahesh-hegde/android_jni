...
import "../os/Messenger.dart" as messenger_;
...
class VisualVoicemailService_VisualVoicemailTask extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/os/Messenger;I)V");

  /// from: void <init>(android.os.Messenger replyTo, int taskId)
  /// The returned object must be deleted after use, by calling the `delete` method.
  VisualVoicemailService_VisualVoicemailTask(
      messenger_.Messenger replyTo, int taskId)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [replyTo.reference, taskId]).object);
