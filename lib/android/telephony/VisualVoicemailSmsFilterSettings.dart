...
class VisualVoicemailSmsFilterSettings extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/telephony/VisualVoicemailSmsFilterSettings\$Builder;)V");

  /// from: void <init>(android.telephony.VisualVoicemailSmsFilterSettings.Builder builder)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Use Builder to construct
  VisualVoicemailSmsFilterSettings(
      VisualVoicemailSmsFilterSettings_Builder builder)
