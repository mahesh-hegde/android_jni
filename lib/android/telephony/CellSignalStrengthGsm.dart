...
/// from: android.telephony.CellSignalStrengthGsm
///
/// GSM signal strength related information.
class CellSignalStrengthGsm extends cellsignalstrength_.CellSignalStrength {
  static final _classRef =
      jniAccessors.getClassOf("android/telephony/CellSignalStrengthGsm");
  CellSignalStrengthGsm.fromRef(jni.JObject ref) : super.fromRef(ref);

  static final _id_CREATOR = jniAccessors.getStaticFieldIDOf(
      _classRef, "CREATOR", "Landroid/os/Parcelable\$Creator;");

  /// from: static public final android.os.Parcelable.Creator<android.telephony.CellSignalStrengthGsm> CREATOR
