...
class ScanFilter extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Ljava/lang/String;Ljava/lang/String;Landroid/os/ParcelUuid;Landroid/os/ParcelUuid;Landroid/os/ParcelUuid;[B[BI[B[B)V");

  /// from: void <init>(java.lang.String name, java.lang.String deviceAddress, android.os.ParcelUuid uuid, android.os.ParcelUuid uuidMask, android.os.ParcelUuid serviceDataUuid, byte[] serviceData, byte[] serviceDataMask, int manufacturerId, byte[] manufacturerData, byte[] manufacturerDataMask)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ScanFilter(
      jni.JniString name,
      jni.JniString deviceAddress,
      parceluuid_.ParcelUuid uuid,
      parceluuid_.ParcelUuid uuidMask,
      parceluuid_.ParcelUuid serviceDataUuid,
      jni.JniObject serviceData,
      jni.JniObject serviceDataMask,
      int manufacturerId,
      jni.JniObject manufacturerData,
      jni.JniObject manufacturerDataMask)
