...
class BluetoothServerSocket extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(IZZI)V");

  /// from: void <init>(int type, boolean auth, boolean encrypt, int port)
  ...
  /// privileges
  BluetoothServerSocket(int type, bool auth, bool encrypt, int port)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [type, auth, encrypt, port]).object);
