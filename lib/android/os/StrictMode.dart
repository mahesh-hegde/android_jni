...
class StrictMode_VmPolicy extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(ILjava/util/HashMap;Landroid/os/StrictMode\$OnVmViolationListener;Ljava/util/concurrent/Executor;)V");
...
class StrictMode_ThreadPolicy extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(ILandroid/os/StrictMode\$OnThreadViolationListener;Ljava/util/concurrent/Executor;)V");
  ...
  StrictMode_ThreadPolicy(int mask,
      ...
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [mask, listener.reference, executor.reference]).object);
