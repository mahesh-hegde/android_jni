...
class CleartextNetworkViolation extends violation_.Violation {
  static final _classRef = jniAccessors
      .getClassOf("android/os/strictmode/CleartextNetworkViolation");
  CleartextNetworkViolation.fromRef(jni.JObject ref) : super.fromRef(ref);
