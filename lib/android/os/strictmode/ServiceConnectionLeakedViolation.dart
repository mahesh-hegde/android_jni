...
class ServiceConnectionLeakedViolation extends violation_.Violation {
  static final _classRef = jniAccessors
      .getClassOf("android/os/strictmode/ServiceConnectionLeakedViolation");
  ServiceConnectionLeakedViolation.fromRef(jni.JObject ref)
      : super.fromRef(ref);
