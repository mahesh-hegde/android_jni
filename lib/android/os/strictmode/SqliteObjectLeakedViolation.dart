...
class SqliteObjectLeakedViolation extends violation_.Violation {
  static final _classRef = jniAccessors
      .getClassOf("android/os/strictmode/SqliteObjectLeakedViolation");
  SqliteObjectLeakedViolation.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  SqliteObjectLeakedViolation.ctor1(
      ...
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor1,
            [message.reference, originStack.reference]).object);
}
