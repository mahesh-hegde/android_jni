...
/// from: android.database.sqlite.SQLiteMisuseException
///
...
class SQLiteMisuseException extends sqliteexception_.SQLiteException {
  static final _classRef =
      jniAccessors.getClassOf("android/database/sqlite/SQLiteMisuseException");
  SQLiteMisuseException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  SQLiteMisuseException.ctor1(jni.JniString error)
