...
class FragmentController extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/app/FragmentHostCallback;)V");

  /// from: void <init>(android.app.FragmentHostCallback<?> callbacks)
  /// The returned object must be deleted after use, by calling the `delete` method.
  FragmentController(fragmenthostcallback_.FragmentHostCallback callbacks)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [callbacks.reference]).object);
