...
class Notification_CarExtender_UnreadConversation extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "([Ljava/lang/String;Landroid/app/RemoteInput;Landroid/app/PendingIntent;Landroid/app/PendingIntent;[Ljava/lang/String;J)V");
  ...
  Notification_CarExtender_UnreadConversation(
      ...
      pendingintent_.PendingIntent replyPendingIntent,
      pendingintent_.PendingIntent readPendingIntent,
