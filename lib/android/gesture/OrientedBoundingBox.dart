...
class OrientedBoundingBox extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(FFFFF)V");

  /// from: void <init>(float angle, float cx, float cy, float w, float h)
  /// The returned object must be deleted after use, by calling the `delete` method.
  OrientedBoundingBox(double angle, double cx, double cy, double w, double h)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [angle, cx, cy, w, h]).object);
}
