...
class Prediction extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(Ljava/lang/String;D)V");

  /// from: void <init>(java.lang.String label, double predictionScore)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Prediction(jni.JniString label, double predictionScore)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [label.reference, predictionScore]).object);
