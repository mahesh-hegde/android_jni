...
class ChangedPackages extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/content/pm/ChangedPackages");
  ChangedPackages.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(ILjava/util/List;)V");
  ...
  ChangedPackages(int sequenceNumber, jni.JniObject packageNames)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [sequenceNumber, packageNames.reference]).object);
  ...
  static final _id_getPackageNames = jniAccessors.getMethodIDOf(
      _classRef, "getPackageNames", "()Ljava/util/List;");
  ...
  jni.JniObject getPackageNames() =>
      jni.JniObject.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_getPackageNames, jni.JniType.objectType, []).object);
}
