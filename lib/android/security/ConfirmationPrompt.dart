...
class ConfirmationPrompt extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/content/Context;Ljava/lang/CharSequence;[B)V");

  /// from: void <init>(android.content.Context context, java.lang.CharSequence promptText, byte[] extraData)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ConfirmationPrompt(context_.Context context, jni.JniObject promptText,
      jni.JniObject extraData)
