...
class KeyInfo extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Ljava/lang/String;ZIILjava/util/Date;Ljava/util/Date;Ljava/util/Date;I[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ZIZZZZZ)V");

  /// from: void <init>(java.lang.String keystoreKeyAlias, boolean insideSecureHardware, int origin, int keySize, java.util.Date keyValidityStart, java.util.Date keyValidityForOriginationEnd, java.util.Date keyValidityForConsumptionEnd, int purposes, java.lang.String[] encryptionPaddings, java.lang.String[] signaturePaddings, java.lang.String[] digests, java.lang.String[] blockModes, boolean userAuthenticationRequired, int userAuthenticationValidityDurationSeconds, boolean userAuthenticationRequirementEnforcedBySecureHardware, boolean userAuthenticationValidWhileOnBody, boolean trustedUserPresenceRequired, boolean invalidatedByBiometricEnrollment, boolean userConfirmationRequired)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  KeyInfo(
      jni.JniString keystoreKeyAlias,
