...
/// from: android.security.keystore.SecureKeyImportUnavailableException
///
/// Indicates that the Keystore does not support securely importing wrapped keys.
class SecureKeyImportUnavailableException extends jni.JniObject {
  static final _classRef = jniAccessors.getClassOf(
      "android/security/keystore/SecureKeyImportUnavailableException");
  SecureKeyImportUnavailableException.fromRef(jni.JObject ref)
      : super.fromRef(ref);
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  SecureKeyImportUnavailableException.ctor1(jni.JniString message)
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  SecureKeyImportUnavailableException.ctor2(
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  SecureKeyImportUnavailableException.ctor3(jni.JniObject cause)
