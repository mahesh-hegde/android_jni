...
/// from: android.security.keystore.KeyNotYetValidException
///
/// Indicates that a cryptographic operation failed because the employed key's validity start date
/// is in the future.
class KeyNotYetValidException extends jni.JniObject {
  static final _classRef = jniAccessors
      .getClassOf("android/security/keystore/KeyNotYetValidException");
  KeyNotYetValidException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// cause.
  KeyNotYetValidException.ctor1(jni.JniString message)
  ...
  KeyNotYetValidException.ctor2(jni.JniString message, jni.JniObject cause)
      : super.fromRef(jniAccessors.newObjectWithArgs(
