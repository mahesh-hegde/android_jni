...
class Call_Details extends jni.JniObject {
  ...
  Call_Details(
      ...
      gatewayinfo_.GatewayInfo gatewayInfo,
      int videoState,
      statushints_.StatusHints statusHints,
      bundle_.Bundle extras,
      bundle_.Bundle intentExtras,
      int creationTimeMillis)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [
          telecomCallId.reference,
          handle.reference,
          handlePresentation,
          ...
          capabilities,
          properties,
          disconnectCause.reference,
          connectTimeMillis,
          gatewayInfo.reference,
          videoState,
          statusHints.reference,
          extras.reference,
