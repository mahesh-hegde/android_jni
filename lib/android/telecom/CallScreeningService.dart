...
class CallScreeningService_CallResponse extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(ZZZZ)V");

  /// from: void <init>(boolean shouldDisallowCall, boolean shouldRejectCall, boolean shouldSkipCallLog, boolean shouldSkipNotification)
  /// The returned object must be deleted after use, by calling the `delete` method.
