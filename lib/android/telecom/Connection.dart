...
class Connection_RttTextStream extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/os/ParcelFileDescriptor;Landroid/os/ParcelFileDescriptor;)V");

  /// from: void <init>(android.os.ParcelFileDescriptor toInCall, android.os.ParcelFileDescriptor fromInCall)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  Connection_RttTextStream(parcelfiledescriptor_.ParcelFileDescriptor toInCall,
      parcelfiledescriptor_.ParcelFileDescriptor fromInCall)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [toInCall.reference, fromInCall.reference]).object);
