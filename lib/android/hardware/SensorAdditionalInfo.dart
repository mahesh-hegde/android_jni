...
class SensorAdditionalInfo extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/hardware/Sensor;II[I[F)V");

  /// from: void <init>(android.hardware.Sensor aSensor, int aType, int aSerial, int[] aIntValues, float[] aFloatValues)
  /// The returned object must be deleted after use, by calling the `delete` method.
  SensorAdditionalInfo(sensor_.Sensor aSensor, int aType, int aSerial,
      jni.JniObject aIntValues, jni.JniObject aFloatValues)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [
          aSensor.reference,
          aType,
          aSerial,
          aIntValues.reference,
          aFloatValues.reference
        ]).object);
}
