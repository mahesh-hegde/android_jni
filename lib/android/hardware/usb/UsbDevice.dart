...
class UsbDevice extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Ljava/lang/String;IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");

  /// from: void <init>(java.lang.String name, int vendorId, int productId, int Class, int subClass, int protocol, java.lang.String manufacturerName, java.lang.String productName, java.lang.String version, java.lang.String serialNumber)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  UsbDevice(
      ...
      int subClass,
      int protocol,
      jni.JniString manufacturerName,
      jni.JniString productName,
      jni.JniString version,
      jni.JniString serialNumber)
