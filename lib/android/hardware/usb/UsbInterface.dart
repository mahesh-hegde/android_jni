...
class UsbInterface extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(IILjava/lang/String;III)V");

  /// from: void <init>(int id, int alternateSetting, java.lang.String name, int Class, int subClass, int protocol)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// UsbInterface should only be instantiated by UsbService implementation
  ///@hide
  UsbInterface(int id, int alternateSetting, jni.JniString name, int Class,
