...
import "SensorManager.dart" as sensormanager_;
...
class SensorDirectChannel extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/hardware/SensorManager;IIJ)V");

  /// from: void <init>(android.hardware.SensorManager manager, int id, int type, long size)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  SensorDirectChannel(
      sensormanager_.SensorManager manager, int id, int type, int size)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [manager.reference, id, type, size]).object);
