...
import "../../util/ArraySet.dart" as arrayset_;
...
class FillEventHistory extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(ILandroid/os/Bundle;)V");

  /// from: void <init>(int sessionId, android.os.Bundle clientState)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  FillEventHistory(int sessionId, bundle_.Bundle clientState)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [sessionId, clientState.reference]).object);
...
class FillEventHistory_Event extends jni.JniObject {
  ...
  FillEventHistory_Event(
      int eventType,
      jni.JniString datasetId,
      bundle_.Bundle clientState,
      jni.JniObject selectedDatasetIds,
      arrayset_.ArraySet ignoredDatasetIds,
      jni.JniObject changedFieldIds,
      jni.JniObject changedDatasetIds,
      jni.JniObject manuallyFilledFieldIds,
      jni.JniObject manuallyFilledDatasetIds,
      jni.JniObject detectedFieldIds,
      jni.JniObject detectedFieldClassifications)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [
          eventType,
          datasetId.reference,
          clientState.reference,
          selectedDatasetIds.reference,
          ignoredDatasetIds.reference,
          changedFieldIds.reference,
          changedDatasetIds.reference,
          manuallyFilledFieldIds.reference,
          manuallyFilledDatasetIds.reference,
          detectedFieldIds.reference,
          detectedFieldClassifications.reference
        ]).object);
