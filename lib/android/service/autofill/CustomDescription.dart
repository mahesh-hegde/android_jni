...
class CustomDescription extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/service/autofill/CustomDescription\$Builder;)V");

  /// from: void <init>(android.service.autofill.CustomDescription.Builder builder)
  /// The returned object must be deleted after use, by calling the `delete` method.
  CustomDescription(CustomDescription_Builder builder)
