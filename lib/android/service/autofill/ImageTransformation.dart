...
class ImageTransformation extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/service/autofill/ImageTransformation\$Builder;)V");

  /// from: void <init>(android.service.autofill.ImageTransformation.Builder builder)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ImageTransformation(ImageTransformation_Builder builder)
