...
///
class SparseArray extends jni.JniObject {
  static final _classRef = jniAccessors.getClassOf("android/util/SparseArray");
  SparseArray.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  SparseArray.ctor1(int initialCapacity)
      : super.fromRef(jniAccessors
            .newObjectWithArgs(_classRef, _id_ctor1, [initialCapacity]).object);

  static final _id_clone = jniAccessors.getMethodIDOf(
      _classRef, "clone", "()Landroid/util/SparseArray;");

  /// from: public android.util.SparseArray<E> clone()
  /// The returned object must be deleted after use, by calling the `delete` method.
  SparseArray clone() => SparseArray.fromRef(jniAccessors.callMethodWithArgs(
  ...
  static final _id_remove =
      jniAccessors.getMethodIDOf(_classRef, "remove", "(I)V");

  /// from: public void remove(int key)
  ///
  ...
  static final _id_removeAtRange =
      jniAccessors.getMethodIDOf(_classRef, "removeAtRange", "(II)V");

  /// from: public void removeAtRange(int index, int size)
  ///
  ...
  /// the behavior is undefined.
  ///
  void removeAtRange(int index, int size) => jniAccessors.callMethodWithArgs(
      reference,
      _id_removeAtRange,
