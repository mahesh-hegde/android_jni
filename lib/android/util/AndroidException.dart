...
class AndroidException extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/util/AndroidException");
  AndroidException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  AndroidException.ctor1(jni.JniString name)
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  AndroidException.ctor2(jni.JniString name, jni.JniObject cause)
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  AndroidException.ctor3(jni.JniObject cause)
      : super.fromRef(jniAccessors
