...
/// from: android.util.SparseLongArray
///
...
///
class SparseLongArray extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/util/SparseLongArray");
  SparseLongArray.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  SparseLongArray.ctor1(int initialCapacity)
      : super.fromRef(jniAccessors
            .newObjectWithArgs(_classRef, _id_ctor1, [initialCapacity]).object);

  static final _id_clone = jniAccessors.getMethodIDOf(
      _classRef, "clone", "()Landroid/util/SparseLongArray;");

  /// from: public android.util.SparseLongArray clone()
  /// The returned object must be deleted after use, by calling the `delete` method.
  SparseLongArray clone() =>
      SparseLongArray.fromRef(jniAccessors.callMethodWithArgs(
          reference, _id_clone, jni.JniType.objectType, []).object);

  static final _id_get0 = jniAccessors.getMethodIDOf(_classRef, "get", "(I)J");

  /// from: public long get(int key)
  ///
  /// Gets the long mapped from the specified key, or <code>0</code>
  /// if no such mapping has been made.
  int get0(int key) => jniAccessors.callMethodWithArgs(
      reference, _id_get0, jni.JniType.longType, [key]).long;

  static final _id_get1 = jniAccessors.getMethodIDOf(_classRef, "get", "(IJ)J");

  /// from: public long get(int key, long valueIfKeyNotFound)
  ///
  ...
  static final _id_put = jniAccessors.getMethodIDOf(_classRef, "put", "(IJ)V");

  /// from: public void put(int key, long value)
  ///
  ...
  static final _id_valueAt =
      jniAccessors.getMethodIDOf(_classRef, "valueAt", "(I)J");

  /// from: public long valueAt(int index)
  ///
  /// Given an index in the range <code>0...size()-1</code>, returns
  ...
  int valueAt(int index) => jniAccessors.callMethodWithArgs(
      reference, _id_valueAt, jni.JniType.longType, [index]).long;
  ...
  static final _id_indexOfValue =
      jniAccessors.getMethodIDOf(_classRef, "indexOfValue", "(J)I");

  /// from: public int indexOfValue(long value)
  ///
  ...
  static final _id_append =
      jniAccessors.getMethodIDOf(_classRef, "append", "(IJ)V");

  /// from: public void append(int key, long value)
  ///
