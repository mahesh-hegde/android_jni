...
/// from: android.util.PrintWriterPrinter
///
/// Implementation of a android.util.Printer that sends its output
/// to a java.io.PrintWriter.
class PrintWriterPrinter extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/util/PrintWriterPrinter");
  PrintWriterPrinter.fromRef(jni.JObject ref) : super.fromRef(ref);

  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Ljava/io/PrintWriter;)V");

  /// from: public void <init>(java.io.PrintWriter pw)
  ...
  PrintWriterPrinter(jni.JniObject pw)
