...
class AudioFocusRequest extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/media/AudioManager\$OnAudioFocusChangeListener;Landroid/os/Handler;Landroid/media/AudioAttributes;II)V");

  /// from: void <init>(android.media.AudioManager.OnAudioFocusChangeListener listener, android.os.Handler handler, android.media.AudioAttributes attr, int focusGain, int flags)
  /// The returned object must be deleted after use, by calling the `delete` method.
  AudioFocusRequest(
      audiomanager_.AudioManager_OnAudioFocusChangeListener listener,
      handler_.Handler handler,
      audioattributes_.AudioAttributes attr,
      int focusGain,
      int flags)
