...
class MediaCodec extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Ljava/lang/String;ZZ)V");

  /// from: void <init>(java.lang.String name, boolean nameIsType, boolean encoder)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaCodec(jni.JniString name, bool nameIsType, bool encoder)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [name.reference, nameIsType, encoder]).object);
...
class MediaCodec_CodecException extends jni.JniObject {
  ...
  /// from: void <init>(int errorCode, int actionCode, java.lang.String detailMessage)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaCodec_CodecException(
      int errorCode, int actionCode, jni.JniString detailMessage)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [errorCode, actionCode, detailMessage.reference]).object);
