...
class ImageReader extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(IIIIJ)V");

  /// from: void <init>(int width, int height, int format, int maxImages, long usage)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  ImageReader(int width, int height, int format, int maxImages, int usage)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [width, height, format, maxImages, usage]).object);
