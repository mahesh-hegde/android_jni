...
class MediaCodecInfo extends jni.JniObject {
  ...
  /// from: void <init>(java.lang.String name, boolean isEncoder, android.media.MediaCodecInfo.CodecCapabilities[] caps)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaCodecInfo(jni.JniString name, bool isEncoder, jni.JniObject caps)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [name.reference, isEncoder, caps.reference]).object);
