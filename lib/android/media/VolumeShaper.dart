...
class VolumeShaper_Operation extends jni.JniObject {
  ...
  /// from: void <init>(int flags, int replaceId, float xOffset)
  /// The returned object must be deleted after use, by calling the `delete` method.
  VolumeShaper_Operation(int flags, int replaceId, double xOffset)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [flags, replaceId, xOffset]).object);
...
class VolumeShaper_Configuration extends jni.JniObject {
  ...
  /// from: void <init>(int id)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide Constructs a {@code VolumeShaper} from an id.
  ///
  ...
  VolumeShaper_Configuration(int id)
      : super.fromRef(
            jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [id]).object);
