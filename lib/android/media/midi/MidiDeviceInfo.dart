...
class MidiDeviceInfo extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(IIII[Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;Z)V");

  /// from: void <init>(int type, int id, int numInputPorts, int numOutputPorts, java.lang.String[] inputPortNames, java.lang.String[] outputPortNames, android.os.Bundle properties, boolean isPrivate)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  MidiDeviceInfo(
      ...
      int numInputPorts,
      int numOutputPorts,
      jni.JniObject inputPortNames,
      jni.JniObject outputPortNames,
      ...
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor, [
          ...
          numInputPorts,
          numOutputPorts,
          inputPortNames.reference,
          outputPortNames.reference,
...
class MidiDeviceInfo_PortInfo extends jni.JniObject {
  ...
  /// from: void <init>(int type, int portNumber, java.lang.String name)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MidiDeviceInfo_PortInfo(int type, int portNumber, jni.JniString name)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [type, portNumber, name.reference]).object);
