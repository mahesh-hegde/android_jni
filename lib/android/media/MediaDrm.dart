...
class MediaDrm_MediaDrmStateException extends jni.JniObject {
  ...
  /// from: void <init>(int errorCode, java.lang.String detailMessage)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  MediaDrm_MediaDrmStateException(int errorCode, jni.JniString detailMessage)
...
class MediaDrm_KeyStatus extends jni.JniObject {
  ...
  static final _id_ctor =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "([BI)V");

  /// from: void <init>(byte[] keyId, int statusCode)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaDrm_KeyStatus(jni.JniObject keyId, int statusCode)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [keyId.reference, statusCode]).object);
...
class MediaDrm_CryptoSession extends jni.JniObject {
  ...
  /// from: void <init>(byte[] sessionId, java.lang.String cipherAlgorithm, java.lang.String macAlgorithm)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaDrm_CryptoSession(jni.JniObject sessionId, jni.JniString cipherAlgorithm,
      jni.JniString macAlgorithm)
