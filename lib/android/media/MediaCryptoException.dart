...
/// from: android.media.MediaCryptoException
///
...
class MediaCryptoException extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/media/MediaCryptoException");
  MediaCryptoException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  MediaCryptoException(jni.JniString detailMessage)
