...
class MediaRouter extends jni.JniObject {
  ...
  ///
  /// @hide
  MediaRouter(context_.Context context)
...
class MediaRouter_UserRouteInfo extends MediaRouter_RouteInfo {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/media/MediaRouter\$RouteCategory;)V");

  /// from: void <init>(android.media.MediaRouter.RouteCategory category)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaRouter_UserRouteInfo(MediaRouter_RouteCategory category)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [category.reference]).object);
...
class MediaRouter_RouteInfo extends jni.JniObject {
  ...
  /// from: void <init>(android.media.MediaRouter.RouteCategory category)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaRouter_RouteInfo(MediaRouter_RouteCategory category)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [category.reference]).object);
...
class MediaRouter_RouteGroup extends MediaRouter_RouteInfo {
  ...
  /// from: void <init>(android.media.MediaRouter.RouteCategory category)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaRouter_RouteGroup(MediaRouter_RouteCategory category)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [category.reference]).object);
...
class MediaRouter_RouteCategory extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Ljava/lang/CharSequence;IZ)V");

  /// from: void <init>(java.lang.CharSequence name, int types, boolean groupable)
  /// The returned object must be deleted after use, by calling the `delete` method.
  MediaRouter_RouteCategory(jni.JniObject name, int types, bool groupable)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [name.reference, types, groupable]).object);
