...
class DrmInitData_SchemeInitData extends jni.JniObject {
  ...
  /// from: void <init>(java.lang.String mimeType, byte[] data)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @param mimeType The mimeType of the initialization data.
  ///@param data The initialization data.
  ///@hide
  DrmInitData_SchemeInitData(jni.JniString mimeType, jni.JniObject data)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [mimeType.reference, data.reference]).object);
