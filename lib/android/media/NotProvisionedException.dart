...
/// from: android.media.NotProvisionedException
///
...
/// the operation.
class NotProvisionedException extends mediadrmexception_.MediaDrmException {
  static final _classRef =
      jniAccessors.getClassOf("android/media/NotProvisionedException");
  NotProvisionedException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  NotProvisionedException(jni.JniString detailMessage)
