...
/// from: android.media.MediaDrmResetException
///
...
class MediaDrmResetException extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/media/MediaDrmResetException");
  MediaDrmResetException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  MediaDrmResetException(jni.JniString detailMessage)
