...
class GridLayout_Spec extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(ZIILandroid/widget/GridLayout\$Alignment;F)V");

  /// from: void <init>(boolean startDefined, int start, int size, android.widget.GridLayout.Alignment alignment, float weight)
  /// The returned object must be deleted after use, by calling the `delete` method.
  GridLayout_Spec(bool startDefined, int start, int size,
      GridLayout_Alignment alignment, double weight)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [startDefined, start, size, alignment.reference, weight]).object);
