...
class LinkAddress extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Ljava/net/InterfaceAddress;)V");

  /// from: void <init>(java.net.InterfaceAddress interfaceAddress)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  ...
  ///@hide
  LinkAddress(jni.JniObject interfaceAddress)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [interfaceAddress.reference]).object);
