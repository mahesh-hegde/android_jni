...
/// from: android.net.sip.SipException
///
/// Indicates a general SIP-related exception.
class SipException extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/net/sip/SipException");
  SipException.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  SipException.ctor1(jni.JniString message)
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  SipException.ctor2(jni.JniString message, jni.JniObject cause)
      : super.fromRef(jniAccessors.newObjectWithArgs(
