...
class WifiManager_WifiLock extends jni.JniObject {
  ...
  /// from: void <init>(int lockType, java.lang.String tag)
  /// The returned object must be deleted after use, by calling the `delete` method.
  WifiManager_WifiLock(int lockType, jni.JniString tag)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor, [lockType, tag.reference]).object);
...
class WifiManager_MulticastLock extends jni.JniObject {
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  WifiManager_MulticastLock(jni.JniString tag)
...
class WifiManager_LocalOnlyHotspotReservation extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(Landroid/net/wifi/WifiConfiguration;)V");

  /// from: void <init>(android.net.wifi.WifiConfiguration config)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  WifiManager_LocalOnlyHotspotReservation(
      wificonfiguration_.WifiConfiguration config)
      : super.fromRef(jniAccessors
            .newObjectWithArgs(_classRef, _id_ctor, [config.reference]).object);
