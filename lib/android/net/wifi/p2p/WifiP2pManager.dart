...
class WifiP2pManager_Channel extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/content/Context;Landroid/os/Looper;Landroid/net/wifi/p2p/WifiP2pManager\$ChannelListener;Landroid/os/Binder;Landroid/net/wifi/p2p/WifiP2pManager;)V");

  /// from: void <init>(android.content.Context context, android.os.Looper looper, android.net.wifi.p2p.WifiP2pManager.ChannelListener l, android.os.Binder binder, android.net.wifi.p2p.WifiP2pManager p2pManager)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  WifiP2pManager_Channel(
      ...
      WifiP2pManager_ChannelListener l,
      binder_.Binder binder,
