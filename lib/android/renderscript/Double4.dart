...
/// from: android.renderscript.Double4
///
/// Vector version of the basic double type.
/// Provides four double fields packed.
class Double4 extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/renderscript/Double4");
  Double4.fromRef(jni.JObject ref) : super.fromRef(ref);

  static final _id_w = jniAccessors.getFieldIDOf(_classRef, "w", "D");

  /// from: public double w
  double get w => jniAccessors
      .getField(reference, _id_w, jni.JniType.doubleType)
      .doubleFloat;

  /// from: public double w
  set w(double value) => jniEnv.SetDoubleField(reference, _id_w, value);
  ...
  static final _id_ctor1 =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(DDDD)V");

  /// from: public void <init>(double x, double y, double z, double w)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Double4.ctor1(double x, double y, double z, double w)
