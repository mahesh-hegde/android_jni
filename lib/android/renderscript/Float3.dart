...
/// from: android.renderscript.Float3
///
/// Vector version of the basic float type.
/// Provides three float fields packed.
class Float3 extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/renderscript/Float3");
  Float3.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// from: public void <init>(float x, float y, float z)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Float3.ctor1(double x, double y, double z)
