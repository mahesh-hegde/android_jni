...
/// from: android.renderscript.Int3
///
/// Vector version of the basic int type.
/// Provides three int fields packed.
class Int3 extends jni.JniObject {
  static final _classRef = jniAccessors.getClassOf("android/renderscript/Int3");
  Int3.fromRef(jni.JObject ref) : super.fromRef(ref);
