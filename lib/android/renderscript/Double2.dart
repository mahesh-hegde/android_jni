...
/// from: android.renderscript.Double2
///
/// Vector version of the basic double type.
/// Provides two double fields packed.
class Double2 extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/renderscript/Double2");
  Double2.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  static final _id_ctor1 =
      jniAccessors.getMethodIDOf(_classRef, "<init>", "(DD)V");

  /// from: public void <init>(double x, double y)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Double2.ctor1(double x, double y)
