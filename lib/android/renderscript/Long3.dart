...
/// from: android.renderscript.Long3
///
/// Vector version of the basic long type.
/// Provides three long fields packed.
class Long3 extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/renderscript/Long3");
  Long3.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// from: public void <init>(long x, long y, long z)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Long3.ctor1(int x, int y, int z)
