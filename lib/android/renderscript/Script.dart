...
class Script extends baseobj_.BaseObj {
  ...
  Script(int id, renderscript_.RenderScript rs)
...
class Script_KernelID extends baseobj_.BaseObj {
  ...
  static final _id_ctor1 = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(JLandroid/renderscript/RenderScript;Landroid/renderscript/Script;II)V");

  /// from: void <init>(long id, android.renderscript.RenderScript rs, android.renderscript.Script s, int slot, int sig)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Script_KernelID.ctor1(
      int id, renderscript_.RenderScript rs, Script s, int slot, int sig)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor1,
            [id, rs.reference, s.reference, slot, sig]).object);
}
...
class Script_InvokeID extends baseobj_.BaseObj {
  ...
  static final _id_ctor1 = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(JLandroid/renderscript/RenderScript;Landroid/renderscript/Script;I)V");

  /// from: void <init>(long id, android.renderscript.RenderScript rs, android.renderscript.Script s, int slot)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Script_InvokeID.ctor1(
      int id, renderscript_.RenderScript rs, Script s, int slot)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor1,
            [id, rs.reference, s.reference, slot]).object);
}
...
class Script_Builder extends jni.JniObject {
  ...
  /// from: void <init>(android.renderscript.RenderScript rs)
  /// The returned object must be deleted after use, by calling the `delete` method.
  Script_Builder(renderscript_.RenderScript rs)
      : super.fromRef(jniAccessors
