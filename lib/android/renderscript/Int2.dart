...
/// from: android.renderscript.Int2
///
/// Vector version of the basic int type.
/// Provides two int fields packed.
class Int2 extends jni.JniObject {
  static final _classRef = jniAccessors.getClassOf("android/renderscript/Int2");
  Int2.fromRef(jni.JObject ref) : super.fromRef(ref);
