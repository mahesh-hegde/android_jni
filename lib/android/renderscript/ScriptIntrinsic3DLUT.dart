...
class ScriptIntrinsic3DLUT extends scriptintrinsic_.ScriptIntrinsic {
  ...
  static final _id_ctor1 = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(JLandroid/renderscript/RenderScript;Landroid/renderscript/Element;)V");

  /// from: void <init>(long id, android.renderscript.RenderScript rs, android.renderscript.Element e)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ScriptIntrinsic3DLUT.ctor1(
      int id, renderscript_.RenderScript rs, element_.Element e)
      : super.fromRef(jniAccessors.newObjectWithArgs(
            _classRef, _id_ctor1, [id, rs.reference, e.reference]).object);
