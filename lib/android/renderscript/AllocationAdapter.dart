...
class AllocationAdapter extends allocation_.Allocation {
  ...
  static final _id_ctor2 = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(JLandroid/renderscript/RenderScript;Landroid/renderscript/Allocation;Landroid/renderscript/Type;)V");

  /// from: void <init>(long id, android.renderscript.RenderScript rs, android.renderscript.Allocation alloc, android.renderscript.Type t)
  /// The returned object must be deleted after use, by calling the `delete` method.
  AllocationAdapter.ctor2(int id, renderscript_.RenderScript rs,
      allocation_.Allocation alloc, type_.Type t)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor2,
            [id, rs.reference, alloc.reference, t.reference]).object);
