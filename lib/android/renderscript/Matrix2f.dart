...
/// from: android.renderscript.Matrix2f
///
/// Class for exposing the native RenderScript rs_matrix2x2 type back to the Android system.
class Matrix2f extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/renderscript/Matrix2f");
  Matrix2f.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  ///                  floats long
  Matrix2f.ctor1(jni.JniObject dataArray)
  ...
  static final _id_load = jniAccessors.getMethodIDOf(
      _classRef, "load", "(Landroid/renderscript/Matrix2f;)V");

  /// from: public void load(android.renderscript.Matrix2f src)
  ///
  /// Sets the values of the matrix to those of the parameter
  ///@param src matrix to load the values from
  void load(Matrix2f src) => jniAccessors.callMethodWithArgs(
  ...
  void loadRotate(double rot) => jniAccessors.callMethodWithArgs(
      reference, _id_loadRotate, jni.JniType.voidType, [rot]).check();
  ...
  /// from: public void loadMultiply(android.renderscript.Matrix2f lhs, android.renderscript.Matrix2f rhs)
  ///
  ...
  static final _id_multiply = jniAccessors.getMethodIDOf(
      _classRef, "multiply", "(Landroid/renderscript/Matrix2f;)V");

  /// from: public void multiply(android.renderscript.Matrix2f rhs)
  ///
  /// Post-multiplies the current matrix by a given parameter
  ///@param rhs right hand side to multiply by
  void multiply(Matrix2f rhs) => jniAccessors.callMethodWithArgs(
  ...
  void rotate(double rot) => jniAccessors.callMethodWithArgs(
      reference, _id_rotate, jni.JniType.voidType, [rot]).check();
