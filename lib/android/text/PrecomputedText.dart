...
class PrecomputedText_Params extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(_classRef, "<init>",
      "(Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;II)V");

  /// from: void <init>(android.text.TextPaint paint, android.text.TextDirectionHeuristic textDir, int strategy, int frequency)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @hide
  PrecomputedText_Params(
      ...
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [paint.reference, textDir.reference, strategy, frequency]).object);
