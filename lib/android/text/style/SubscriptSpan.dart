...
/// from: android.text.style.SubscriptSpan
///
...
class SubscriptSpan extends metricaffectingspan_.MetricAffectingSpan {
  static final _classRef =
      jniAccessors.getClassOf("android/text/style/SubscriptSpan");
  SubscriptSpan.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  SubscriptSpan.ctor1(parcel_.Parcel src)
