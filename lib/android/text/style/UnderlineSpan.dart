...
/// from: android.text.style.UnderlineSpan
///
...
class UnderlineSpan extends characterstyle_.CharacterStyle {
  static final _classRef =
      jniAccessors.getClassOf("android/text/style/UnderlineSpan");
  UnderlineSpan.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  UnderlineSpan.ctor1(parcel_.Parcel src)
