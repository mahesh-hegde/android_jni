...
class BidiFormatter extends jni.JniObject {
  ...
  static final _id_ctor = jniAccessors.getMethodIDOf(
      _classRef, "<init>", "(ZILandroid/text/TextDirectionHeuristic;)V");

  /// from: void <init>(boolean isRtlContext, int flags, android.text.TextDirectionHeuristic heuristic)
  ...
  BidiFormatter(bool isRtlContext, int flags,
      textdirectionheuristic_.TextDirectionHeuristic heuristic)
      : super.fromRef(jniAccessors.newObjectWithArgs(_classRef, _id_ctor,
            [isRtlContext, flags, heuristic.reference]).object);
