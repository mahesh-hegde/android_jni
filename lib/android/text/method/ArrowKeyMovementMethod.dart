...
/// from: android.text.method.ArrowKeyMovementMethod
///
/// A movement method that provides cursor movement and selection.
/// Supports displaying the context menu on DPad Center.
class ArrowKeyMovementMethod extends basemovementmethod_.BaseMovementMethod {
  static final _classRef =
      jniAccessors.getClassOf("android/text/method/ArrowKeyMovementMethod");
  ArrowKeyMovementMethod.fromRef(jni.JObject ref) : super.fromRef(ref);
