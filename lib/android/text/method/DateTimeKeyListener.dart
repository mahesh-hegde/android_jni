...
/// from: android.text.method.DateTimeKeyListener
///
...
class DateTimeKeyListener extends numberkeylistener_.NumberKeyListener {
  static final _classRef =
      jniAccessors.getClassOf("android/text/method/DateTimeKeyListener");
  DateTimeKeyListener.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  DateTimeKeyListener.ctor1(jni.JniObject locale)
  ...
  static final _id_getInstance = jniAccessors.getStaticMethodIDOf(
      _classRef, "getInstance", "()Landroid/text/method/DateTimeKeyListener;");

  /// from: static public android.text.method.DateTimeKeyListener getInstance()
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// @deprecated Use \#getInstance(Locale) instead.
  ///@return This value will never be {@code null}.
  static DateTimeKeyListener getInstance() =>
      DateTimeKeyListener.fromRef(jniAccessors.callStaticMethodWithArgs(
  ...
  /// from: static public android.text.method.DateTimeKeyListener getInstance(java.util.Locale locale)
  /// The returned object must be deleted after use, by calling the `delete` method.
  ///
  /// Returns an instance of DateTimeKeyListener appropriate for the given locale.
  ///@param locale This value may be {@code null}.
  ///@return This value will never be {@code null}.
  static DateTimeKeyListener getInstance1(jni.JniObject locale) =>
      DateTimeKeyListener.fromRef(jniAccessors.callStaticMethodWithArgs(
          _classRef,
          _id_getInstance1,
