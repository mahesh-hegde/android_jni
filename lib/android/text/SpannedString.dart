...
/// from: android.text.SpannedString
///
...
class SpannedString extends jni.JniObject {
  static final _classRef =
      jniAccessors.getClassOf("android/text/SpannedString");
  SpannedString.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  SpannedString(jni.JniObject source)
  ...
  /// from: static public android.text.SpannedString valueOf(java.lang.CharSequence source)
  /// The returned object must be deleted after use, by calling the `delete` method.
  static SpannedString valueOf(jni.JniObject source) =>
      SpannedString.fromRef(jniAccessors.callStaticMethodWithArgs(_classRef,
