...
/// from: android.transition.ChangeScroll
///
/// This transition captures the scroll properties of targets before and after
/// the scene change and animates any changes.
class ChangeScroll extends transition_.Transition {
  static final _classRef =
      jniAccessors.getClassOf("android/transition/ChangeScroll");
  ChangeScroll.fromRef(jni.JObject ref) : super.fromRef(ref);
  ...
  /// The returned object must be deleted after use, by calling the `delete` method.
  ChangeScroll.ctor1(context_.Context context, attributeset_.AttributeSet attrs)
